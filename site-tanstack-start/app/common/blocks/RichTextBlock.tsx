...
import { type LinkBlockData, type RichTextBlockData } from "@app/blocks.generated";
import { Typography, type TypographyProps } from "@app/common/components/Typography";
import { isValidLink } from "@app/common/helpers/HiddenIfInvalidLink";
...
const redraft = defaultRedraft.default || defaultRedraft; //TODO client vs server side issue?!
