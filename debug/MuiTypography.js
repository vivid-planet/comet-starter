...
console.log("### Using custom Typography.js (Build 10 ESM)");
...
const Typography = /*#__PURE__*/ React.forwardRef(function Typography(inProps, ref) {
    console.log("### rendering Typography");
    ...
    if (debugRicky) {
        console.log("### debugRicky", {
            debugRicky,
            themeProps,
            theme: theme.components.MuiTypography.defaultProps,
            propsVariantMapping: props.variantMapping,
            defaultVariantMapping,
            usedVariantMapping: variantMapping,
        });
    }
...
process.env.NODE_ENV !== "production"
    ? (Typography.propTypes /* remove-proptypes */ = {
          ...
          color: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([
              PropTypes.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]),
              PropTypes.string,
          ]),
          /**
