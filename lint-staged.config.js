module.exports = {
    ...
    "mcp-server/src/**/*.{ts,js,json,md}": () => "npm --prefix mcp-server run lint:eslint",
    "mcp-server/**/*.{ts}": () => "npm --prefix mcp-server run lint:tsc",
    "mcp-server/*.{ts,js,json,md,yml,yaml}": () => "npm --prefix mcp-server run lint:prettier",
