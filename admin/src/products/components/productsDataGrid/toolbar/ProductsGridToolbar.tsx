...
export interface ProductsGridToolbarProps extends GridToolbarProps {
    toolbarAction?: ReactNode;
    exportApi: ExportApi;
}

export function ProductsGridToolbar({ toolbarAction, exportApi }: ProductsGridToolbarProps) {
    return (
        <DataGridToolbar>
