...
export const CallToActionListBlock = createListBlock({
    ...
    itemName: <FormattedMessage id="callToActionListBlock.itemName" defaultMessage="Call To Action" />,
    itemsName: <FormattedMessage id="callToActionListBlock.itemsName" defaultMessage="Call To Action List" />,
});
