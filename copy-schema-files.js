...
(async () => {
    await Promise.all([
        ...
        fs.promises.copyFile("site-configs.d.ts", "api/src/site-configs.d.ts"),
        fs.promises.copyFile("site-configs.d.ts", "admin/src/site-configs.d.ts"),
        fs.promises.copyFile("site-configs.d.ts", "site/src/site-configs.d.ts"),
    ]);
})();
